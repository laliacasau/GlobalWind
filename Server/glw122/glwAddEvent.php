...
$sql = "INSERT INTO glwEvents (directorKey,eventNum,server,directorName,
    ...
    crtDir,crtSpeed,
    sailMode,eventName,eventKey,extra1,extra2,waterDepth,updBoatPos,wavesType,systemMode,
    setterSimName)
VALUES ('$winddata[0]','$winddata[1]','$winddata[3]','$winddata[4]',
    ...
    $winddata[18],'$winddata[19]','$winddata[20]','$winddata[21]','$winddata[22]',$winddata[23],$winddata[24],'$winddata[25]',$winddata[26],
    '$regionname')";
if ($conn->query($sql) === TRUE) {
    ...
    print "OK,".$idEvents.",".$eventname;
} else {
    die("KO|".$conn->error."|".$sql);
}
$conn->close();
//end
