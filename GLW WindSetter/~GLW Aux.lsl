...
list gaGlwdefv=[0,15,0,0,60,3,0,0,0,50,3,0,0,2,"","","","",0,0,""];  //default values
...
//psData=["wind dir","wind speed","wind gusts","wind shifts","wind period","wave speed","wave height variance","wave length variance","wave height","wave length","wave effects","current dir","current speed","sail mode","name","extra1","extra2","water depth","update pos","system mode",
fStart(key pkTarget)  //start wind from GLW script
{
    gsMsgGLW="GLW sailors your wind today is "+llList2String(gaGlwv,0)+"º "+llList2String(gaGlwv,1)+"kt. ";
    if(llList2Integer(gaGlwv,4)>0) gsMsgGLW+=" Gusts:"+llList2String(gaGlwv,2);
    if(llList2Integer(gaGlwv,5)>0) gsMsgGLW+=" Shift:"+llList2String(gaGlwv,3);
    gsMsgGLW+=". Say 'glw' or 'racing'";
    ...
    llMessageLinked(LINK_THIS, 1203, (string)gsMsgGLW, (string)giInterval+","+(string)giIntervalMsg+","+(string)giDirectorMsg+","+(string)giPeriod);  //send data controls 
...
//gaGlwv=["wind dir","wind speed","wind gusts","wind shifts","wind period","wave speed","wave height variance","wave length variance","wave height","wave length","wave effects","current dir","current speed","sail mode","name","extra1","extra2","water depth","update pos","system mode"##Vars Areas##Vars Circles
